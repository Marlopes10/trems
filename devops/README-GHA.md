...
2. Go to your repository at [Marlopes10/trems](https://github.com/Marlopes10/trems).
3. Click on `Settings` at the top-right corner.
4. In the left sidebar, click on `Environments`.
5. Press `New environment`.
6. Name the environment `trems-marlopes10-tangrama.com.br` and hit `Configure environment`.
...
|-------------|--------------|-------------|
| DEPLOY_HOST | trems-marlopes10-tangrama.com.br | The hostname or IP address of your Docker Swarm manager. |
...
| Name     | Value |
|----------|-------|
| LIVE_ENV | trems-marlopes10-tangrama.com.br |
...
- [Backend Tests Workflow](https://github.com/Marlopes10/trems/actions/workflows/backend.yml)
- [Frontend Tests Workflow](https://github.com/Marlopes10/trems/actions/workflows/frontend.yml)

Upon successful completion of the tests, Docker images for the Backend (`ghcr.io/Marlopes10/trems-backend`) and Frontend (`ghcr.io/Marlopes10/trems-frontend`) will be available.

### Initiating Manual Deployment

1. Navigate to [Manual Deployment of trems-marlopes10-tangrama.com.br](https://github.com/Marlopes10/trems/actions/workflows/manual-deploy.yml).
...
- Initiate a new deployment using the `devops/stacks/trems-marlopes10-tangrama.com.br.yml` stack.
