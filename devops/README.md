...
```
DEPLOY_ENV=prod
DEPLOY_HOST=trems-marlopes10-tangrama.com.br
DEPLOY_PORT=22
DEPLOY_USER=plone
...
prod:
  hosts:
    trems-marlopes10-tangrama.com.br:
      ansible_user: root
      host: trems-marlopes10-tangrama
      hostname: trems-marlopes10-tangrama.com.br
```
...
Deploy the stack defined in `devops/stacks/trems-marlopes10-tangrama.com.br.yml` to the remote server with:
